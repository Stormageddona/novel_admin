        ...
        <div class="modify_box">
            ...
            <table>
                ...
                <tr>
                    <td>회원등급</td>
                    <td>
                        <input type="radio" class="modify_input_grade" name="modify_grade" id="modify_grade_label1" data-seq="1">
                        <label for="modify_grade_label1">일반</label>

                        <input type="radio" class="modify_input_grade" name="modify_grade" id="modify_grade_label2" data-seq="2">
                ...
                <tr>
                    <td>회원상태</td>
                    <td>
                        <input type="radio" class="modify_input_status" name="modify_status" id="modify_status_label1" data-seq="1">
                        <label for="modify_status_label1">정상</label>

                        <input type="radio" class="modify_input_status" name="modify_status" id="modify_status_label2" data-seq="2">
                        <label for="modify_status_label2">정지</label>

                        <input type="radio" class="modify_input_status" name="modify_status" id="modify_status_label3" data-seq="3">
